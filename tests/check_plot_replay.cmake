...
foreach(required trajectory_xy.png horizontal_error.png altitude_error.png residuals.png solution_quality.png plot_summary.json)
    if(NOT EXISTS "${OUT_DIR}/plots/${required}")
        message(FATAL_ERROR "missing plot output: ${OUT_DIR}/plots/${required}")
    endif()
endforeach()

file(READ "${OUT_DIR}/plots/plot_summary.json" summary_text)
string(FIND "${summary_text}" "\"rows_radio_solution\"" rows_radio_index)
if(rows_radio_index EQUAL -1)
    message(FATAL_ERROR "plot_summary.json missing rows_radio_solution:\n${summary_text}")
endif()
