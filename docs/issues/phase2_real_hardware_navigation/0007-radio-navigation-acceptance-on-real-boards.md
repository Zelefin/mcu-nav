...
altitude, disable GPS on one node through the telemetry UI and observe an
...
- [ ] The telemetry UI disables local GPS and the resulting solution source is
      not local GNSS.
...
- [ ] Evidence includes telemetry-UI state, serial logs, board identities, and
