...
and simple packet-loss patterns. Coordinates are generated from a local tangent
approximation around the scenario origin; ranges are generated from WGS84 ECEF
positions derived from the emitted lat/lon/alt rows.
